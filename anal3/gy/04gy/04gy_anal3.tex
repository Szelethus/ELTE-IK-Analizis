...
%	\def\theorem{\textbf{Tétel:\ }}
	...
	\begin{task}
		...
		\[ t = \arsh x \]
		Visszatérve:
		\[ \int\sqrt{1+\sh t}\ch t\,dt=\int\sqrt{\ch^2t}\cdot\ch t\,dt=\int|\overbrace{\ch x}^{\text{poz.}}|\cdot\ch t\,dt=\int\ch^2 t\,dt=\int\left(\frac{e^t+e^{-t}}{2}\right)^2\,dt=\]
		...
		\[ \Rightarrow\int\sqrt{1+x^2}\,dx=\frac{\arsh}{2}+\frac{1}{2}\cdot x\cdot \sqrt{1+x^2}+c \]
	\end{task}
	\begin{revision}\
		...
		\begin{center}
			...
			\quad \text{\fbox{$\displaystyle \ch^{-1}(x)=?$}}
		\end{center}
	...
	\begin{task}$x\in\R$
		...
		Próbáljuk átalakítani a nevezőt úgy, hogy egy 
		\begin{center}
		...
		\end{center}
		a törtet.
		\[ x^2-x+1=\left(x-\frac{1}{2}\right)^2-\frac{1}{4}+1=\left(x-\frac{1}{2}\right)^2+\frac{3}{4}= \frac{3}{4}\cdot\left[1+\left(x-\frac{1}{2}\right)^2\right]=\frac{3}{4}\left[1+\frac{(2x-1)^2}{3}\right]=\]
	...
	\end{task}
	Házi feladat: 10 db. racionális tört integrál. 1866-tól. Egy típust nem csináltunk,amikor egy másodfokú polinomnak nincs mgoldása, és az magasabb fokon van.
\end{document}