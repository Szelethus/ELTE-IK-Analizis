...
% 		\[ =\frac{1}{2\sqrt{2}}\cdot I(x)-\frac{1}{2\sqrt{2}}\cdot I(x)+\frac{1}{2\sqrt{2}}\cdot\int\frac{2\sqrt{2}}{x^2+\sqrt{2}x+1}\,dx= \int\frac{1}{x^2+\sqrt{2}x+1}\,dx \]
	...
	\begin{exercise}$x\in\R$
		...
		\vspace{-7mm}
		\begin{align*}
			x=0\quad \Rightarrow&\quad 4=3C\quad \Rightarrow\quad C=\frac{4}{3}\\
			x=-1\quad \Rightarrow&\quad 3=-2B\quad \Rightarrow\quad B=-\frac{3}{2}\\
			x=-3\quad \Rightarrow&\quad 1=6A\quad \Rightarrow\quad A=\frac{1}{6}
		\end{align*}
		Ezalapján:
	...
	\begin{exercise}$x\in(3;+\infty)$
		...
		\begin{align*}
			x=1\quad \Rightarrow&\quad 1=4B\quad \Rightarrow\quad B=\frac{1}{4}\\
			x=-1\quad \Rightarrow&\quad 1=4D\quad \Rightarrow\quad D=\frac{1}{4}
		\end{align*}
	...
	\begin{exercise}
		...
		Így az eredeti integrál:
		\[ \int\frac{1}{\sqrt{x}+\sqrt[3]{x}}\,dx=\frac{\sqrt[6]{x}^3}{3}-\frac{\sqrt[6]{x}^2}{2}+\sqrt[6]{x}-\ln|\sqrt[6]{x}+1|+c=\frac{\sqrt{x}}{3}-\frac{\sqrt[3]{x}}{2}+\sqrt[6]{x}-\ln|\sqrt[6]{x}+1|+c\quad (c\in\R) \]
	\end{exercise}
...
%		Helyettesítsünk be.
%		\[ \int\frac{2-t^2}{3}\cdot t\cdot\frac{6}{(2-t^2)^2}\,dt=\int\frac{2t}{2-t^2}\,dt=-\int\frac{(2-t^2)'}{2-t^2}\,dt=-\ln|2-t^2|+c\quad (c\in\R) \]
%		Az eredeti integrál:
%		\[ \int\frac{1}{x}\sqrt{\frac{2x-3}{x}}\,dx=-\ln\left|2-\left(\sqrt{\frac{2x-3}{x}}\right)^2\right|+c=-\ln\left|2-\frac{2x-3}{x}\right|+c\quad (c\in\R) \]
	\end{exercise}
	\begin{exercise}
		...
		\[ =6\arc\tg t-2\cdot\frac{t}{1+t^2}+c \]
