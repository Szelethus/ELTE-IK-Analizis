...
%	\def\theorem{\textbf{Tétel:\ }}
	...
	\begin{enumerate}
		\item Felteszem, hogy $\exists F:\quad \int f(x)\,dx=F(x)+c$
	...
	\end{task}
	\begin{task}
		\[\sin^2x\,dx=\int\frac{1-\cos2x}{2}\,dx=\frac{1}{2}\left(\int1\,dx-\int\cos2x\,dx=\frac{1}{2}x-\frac{1}{2}\cdot\frac{\sin(2x)}{2}+c\quad (c\in\R)\right) \]
	\end{task}
	\begin{note}
		\[ \begin{cases}
		\sin^2x+cos^2x=1\\
